...
C
     ...
     +  numvarbl,numlevel,ngrid
      ...
      allocate(sumff(numfcst,numvarbl,numlevel,numarea,numvfyobs,11))
      allocate(sumoo(numfcst,numvarbl,numlevel,numarea,numvfyobs,11))
      allocate(sumfo(numfcst,numvarbl,numlevel,numarea,numvfyobs,11))
