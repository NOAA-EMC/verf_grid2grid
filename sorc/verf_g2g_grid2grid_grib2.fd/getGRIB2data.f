...
c
     ...
     +            hh(nfcst),jpd9,ngrid,gfld,iret)
               ...
               if ((grib2file(1:19).eq.'fcst.grib.naefs.cmc').or.
     +              (grib2file(1:13).eq.'fcst.grib.cmc')) then
                call readGB2_CMCE(grbunit,jpdtn,2,2,jpd10,jpd12,yyyy,
     ...
     +           hh(nfcst),jpd9,ngrid,gfld,iret)
               ...
               if ((grib2file(1:19).eq.'fcst.grib.naefs.cmc').or.
     +              (grib2file(1:13).eq.'fcst.grib.cmc')) then
                call readGB2_CMCE(grbunit,jpdtn,2,3,jpd10,jpd12,yyyy,
     +            mm(nfcst),dd(nfcst),hh(nfcst),jpd9,ngrid,gfld,iret)
               else
     ...
     +           hh(nfcst),jpd9,ngrid,gfld,iret)
               ...
               if ((grib2file(1:19).eq.'fcst.grib.naefs.cmc').or.
     +              (grib2file(1:13).eq.'fcst.grib.cmc')) then
             call readGB2_CMCE(grbunit,jpdtn,jpd1,jpd2,jpd10,jpd12,yyyy,
     +           mm(nfcst),dd(nfcst),hh(nfcst),jpd9,ngrid,gfld,iret)
               else
