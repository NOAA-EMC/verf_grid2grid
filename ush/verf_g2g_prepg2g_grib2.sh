...
set -x 
wgrb=/gpfs/dell1/nco/ops/nwprod/grib_util.v1.1.0/exec
...
# and form tendency file pairs
 ...
 read LINE                     #Header 4
   ...
   if [ ${tobsv[1]} -gt 2000000000 ] ; then    #case1:one verified data  vs different previous cycle forecasts
     ...
     obsv03[0]=`/gpfs/dell1/nco/ops/nwprod/prod_util.v1.1.0/exec/ips/ndate -3 ${obsv[0]}`
     oday03[0]=`echo ${obsv03[0]} | cut -c 1-8`
     obsv06[0]=`/gpfs/dell1/nco/ops/nwprod/prod_util.v1.1.0/exec/ips/ndate -6 ${obsv[0]}`
     oday06[0]=`echo ${obsv06[0]} | cut -c 1-8`
     obsv12[0]=`/gpfs/dell1/nco/ops/nwprod/prod_util.v1.1.0/exec/ips/ndate -12 ${obsv[0]}`
     oday12[0]=`echo ${obsv12[0]} | cut -c 1-8`
     obsv24[0]=`/gpfs/dell1/nco/ops/nwprod/prod_util.v1.1.0/exec/ips/ndate -24 ${obsv[0]}`
     ...
     while [ $t -le $nt ]
     do
       pass=` /gpfs/dell1/nco/ops/nwprod/prod_util.v1.1.0/exec/ips/ndate -${f[$t]} ${obsv[0]}`
     ...
     pass=`/gpfs/dell1/nco/ops/nwprod/prod_util.v1.1.0/exec/ips/ndate +${b[0]} ${fcst[0]}`
     pass03=`/gpfs/dell1/nco/ops/nwprod/prod_util.v1.1.0/exec/ips/ndate -3 $pass`
     pass06=`/gpfs/dell1/nco/ops/nwprod/prod_util.v1.1.0/exec/ips/ndate -6 $pass`
     pass12=`/gpfs/dell1/nco/ops/nwprod/prod_util.v1.1.0/exec/ips/ndate -12 $pass`
     pass24=`/gpfs/dell1/nco/ops/nwprod/prod_util.v1.1.0/exec/ips/ndate -24 $pass`
...
echo ${fday[0]}${tf}${b[0]}" "${oday[0]}${to}00" "${fday[0]}${tf}${b03[0]}" "${oday03[0]}${to03}00" "${fday[0]}${tf}${b06[0]}" "${oday06[0]}${to06}00" "${fday[0]}${tf}${b12[0]}" "${oday12[0]}${to12}00" "${fday[0]}${tf}${b24[0]}" "${oday24[0]}${to24}00 >> g2g.ctl
     ...
     while [ $t -lt ${tobsv[0]} ]
      do
       ...
       pass=`/gpfs/dell1/nco/ops/nwprod/prod_util.v1.1.0/exec/ips/ndate +${b[$t]} ${fcst[0]}`
       pass03=`/gpfs/dell1/nco/ops/nwprod/prod_util.v1.1.0/exec/ips/ndate -3 $pass`
       pass06=`/gpfs/dell1/nco/ops/nwprod/prod_util.v1.1.0/exec/ips/ndate -6 $pass`
       pass12=`/gpfs/dell1/nco/ops/nwprod/prod_util.v1.1.0/exec/ips/ndate -12 $pass`
       pass24=`/gpfs/dell1/nco/ops/nwprod/prod_util.v1.1.0/exec/ips/ndate -24 $pass`
